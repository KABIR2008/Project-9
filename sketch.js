...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Distance(KM/SEC): "+ distance,900,40);
  
  if(gameState===PLAY){
    
   distance = distance + Math.round(getFrameRate()/30);
   path.velocityX = -(6 + 30*distance/150 );
...
function pinkCyclists(){
        ...
        player1.scale =0.06;
        player1.velocityX = -(6 + 1*distance/100);
...
function yellowCyclists(){
        ...
        player2.scale =0.06;
        player2.velocityX = -(6 + 1*distance/100);
...
function redCyclists(){
        ...
        player3.scale =0.06;
        player3.velocityX = -(6 + 1*distance/100);
